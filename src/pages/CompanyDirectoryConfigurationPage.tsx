...
const CompanyDirectoryConfigurationPage: React.FC = () => {
  return (
      ...
      <div className="mx-auto box-border flex w-full max-w-content flex-col gap-lg">
        ...
        <Card>
          <CardContent className="p-xl text-body-md text-muted-foreground">
            Configuration content is not implemented in this preview.
          </CardContent>
        </Card>
      </div>
...
export default CompanyDirectoryConfigurationPage;
